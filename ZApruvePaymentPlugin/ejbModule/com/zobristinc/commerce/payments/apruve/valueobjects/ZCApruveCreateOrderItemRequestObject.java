...
public class ZCApruveCreateOrderItemRequestObject extends ZCApruveRequestObject
{
	...
	public JSONObject getJSONRequestObj() throws ECException {
		...
		JSONObject createOrderItemObj = new JSONObject();
		...
		try {
		    ...
		    if(getQuantity() != null)
		      ...
		      //createOrderItemObj.put("order", obj);
			
	     }
		catch(Exception e){
			e.printStackTrace();
		}
		System.out.println("createOrderItemObj is : "+obj);
		return obj;
		/*System.out.println("createOrderItemObj is : "+createOrderItemObj);
		return createOrderItemObj;*/
	}
}
